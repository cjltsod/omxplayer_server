  ...
  <body>
    ...
    <div class="starter-template">
      <div class="container">
        <div class="row">
          <div class="col-md-2">
            <img class="logo img-responsive" src="${request.static_url('omxplayer_server:static/pyramid.png')}" alt="pyramid web framework">
          </div>
          <div class="col-md-10">
            <div class="content">
              <h1><span class="font-semi-bold">Michael English Class</span><br/><span class="smaller">RPi Player Control Panel</span></h1>
              <p class="lead">
        ...
        <div class="row">
          <div class="links">
            <ul>
              <li class="current-version">Generated by v1.0.0</li>
              <li><i class="glyphicon glyphicon-cog icon-muted"></i><a href="https://github.com/cjltsod/omxplayer_server">Github Project</a></li>
              <li><i class="glyphicon glyphicon-home icon-muted"></i><a href="http://pylonsproject.org">Blessing Software</a></li>
          </div>
        </div>
        <div class="row">
          <div class="copyright">
